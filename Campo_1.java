...
try {
    ...
    java.sql.Connection connection = DatabaseConnectioncampo.getConnection();
    // Crear la consulta SQL para insertar los datos en la tabla "campos"
    String insertQuery = "INSERT INTO campos (HoraInicio, HoraFin, CostoTiempo, MontoEquipos, PagoTotal) VALUES (?, ?, ?, ?, ?)";

    // Preparar la declaración SQL
    PreparedStatement preparedStatement = connection.prepareStatement(insertQuery);
    preparedStatement.setString(1, horaInicio);
    preparedStatement.setString(2, horaFin);
    preparedStatement.setDouble(3, costoTiempo);
    preparedStatement.setDouble(4, montoEquipos);
    preparedStatement.setDouble(5, pagoTotal);
